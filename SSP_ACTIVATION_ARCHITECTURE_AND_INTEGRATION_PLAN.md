...
| `Abstractions/ILicenseEnforcement.cs` | `CanStartProtectedService/CanEstablishTunnel/CanCreateSession/CanUseFeature/CheckLimit` → `AuthorizationDecision` | Headless enforcement API | usage counts host-supplied | **Reuse unchanged** |
